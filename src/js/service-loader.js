...
export default class ValidMod {
  ...
  */
  ...
  /**
  * Ajoute un validateur dur une propriété d'une classe.
  * @param { configuration externe} description des validateur à appliquer.
  ...
  */
  ...
  /**
  * Lance la validation à partir d'une configuration externe.
  * @param {conf} description des validateur à appliquer.
  * @param {target} objet à valider.
  */
